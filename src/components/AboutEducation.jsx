        ...
        <div className='font-raleway text-base px-12 xl:pt-16 xl:pl-32 sm:text-6xl md:text-8xl lg:text-lg lg:py-16 lg:px-24'>
            ...
            <p className='text-white text-sm xl:text-xl w-[70dvw] xl:w-[85dvw] xl:h-[50dvh] xl:text-sm xl:flex xl:flex-row xl:flex-wrap'>
                <div className='xl:w-[30dvw]'>
                    <h4 className='uppercase tracking-widest xl:tracking-[0.2rem] font-bold'>Diploma of Information Technology</h4>
                    <h5 className='xl:py-2'>Coder Academy</h5>
                    <h6>2022 - 2023</h6>
                </div>
                <div className='xl:w-[40dvw] xl:pl-36'>
                    <h4 className='uppercase tracking-widest xl:tracking-[0.2rem] font-bold'>Certificate IV in Veterinary Nursing</h4>
                    <h5 className='xl:py-2'>TAFE NSW</h5>
                    <h6>2014 - 2016</h6>
                </div>
                <div className='xl:w-[30dvw]'>
                    <h4 className='uppercase tracking-widest xl:tracking-[0.2rem] font-bold pt-4'>Bachelor of Media and Communications (Honours)</h4>
                    <h5 className='xl:py-2'>University of New Englandy</h5>
                    <h6>2013</h6>
                </div>
                <div className='xl:w-[40dvw] xl:pl-36'>
                    <h4 className='uppercase tracking-widest xl:tracking-[0.2rem] font-bold pt-4'>Bachelor of Arts (writing and philosophy)</h4>
