...
export default function TerminalAppGameComponent() {
    ...
    return (
        <section className='h-[80dvh] w-[90vw] top-[10dvh]'>
            <div className='h-[80dvh] font-raleway text-base pl-10 pr-12 sm:pl-12 md:pt-16 md:pl-20 xl:pt-16 xl:pl-32 sm:text-6xl md:text-8xl lg:text-lg lg:py-16 lg:px-24'>
                ...
                <div className='xl:flex'>
                    ...
                    It features single CLI command to install dependencies and load the game via a bash script,
