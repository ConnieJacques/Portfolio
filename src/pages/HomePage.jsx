        ...
        <div className="h-[80dvh]">
            <div className='flex flex-col justify-center items-center h-[80dvh]'>
                <div data-aos="fade-in" data-aos-duration="5000">
                    <p className="font-raleway text-white text-5xl px-12 pb-10 leading-tight sm:text-6xl sm:leading-relaxed md:text-8xl md:leading-snug lg:text-5xl lg:py-16 lg:px-24 xl:text-4xl xl:w-[60vw] xl:py-0 xl:px-0"> Hi, I'm Connie and I'm a Back-End Web Developer.</p>
